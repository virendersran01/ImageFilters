...
class EditImageViewModel(private  val editImageRepository: EditImageRepository): ViewModel() {
    ...
    private val savedFilteredImageDataState = MutableLiveData<SaveFilteredImageDataState>()
    val saveFilteredImageUiState: LiveData<SaveFilteredImageDataState> get() = savedFilteredImageDataState
    ...
    private fun emitSaveFilteredImageUiState(
        ...
        savedFilteredImageDataState.postValue(dataState)
    }
